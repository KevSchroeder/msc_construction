    ...
    <div className="bg-white">
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">MSC Construction</span>
              <img
      ...
      <main>
        ...
        <div className="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20">
          <Image
                src="/pexels-fwstudio-172289.jpg"
                alt="Home Pic"                
                quality={100}
                fill
                sizes="100vw"
          ...
          >
            <div
              className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#f29648] opacity-40 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
              style={{
                clipPath:
            ...
            <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
              <figure className="relative isolate pt-6 sm:pt-12">
                ...
                <figcaption className="mt-8 text-base">
                  <div className="font-semibold text-white">Michael</div>
                  <div className="mt-1 text-gray-400">Owner of MSC Construction</div>
                </figcaption>
              </figure>
            </div>
          </div>
